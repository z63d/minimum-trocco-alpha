...
o11y-up: helm-repos namespaces helm-minio helm-loki helm-mimir helm-tempo helm-kube-state-metrics helm-alloy helm-otel-collector helm-otel-gateway helm-grafana
...
o11y-down:
  ...
  -helm uninstall kube-state-metrics --namespace o11y
...
helm-kube-state-metrics:
  helm upgrade --install kube-state-metrics prometheus-community/kube-state-metrics \
    --namespace o11y \
    --version 8.0.0 \
    --values k8s/helm/values/kube-state-metrics.yaml \
    --wait --timeout 5m
